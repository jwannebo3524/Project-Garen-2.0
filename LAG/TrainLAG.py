...
learnrate = 0.05 #Less than one, 0.1 is probably too high

#this is the bot training code!!
...
LIO = LIM() #initialize i/o handler
 ...
 #The learn rate- this is per action cycle. Set to zero to freeze weights
AgentSupervised = True #if set to true, agent tries to mimics your output rather than generating its own. Good for pre-training
Imitate = True
ConstantReward = True #primarily for imitation 
CONST = 1
Negitive = -0.1
...
print("LAG training mode ready. Starting in 5 seconds")
time.sleep(5)
